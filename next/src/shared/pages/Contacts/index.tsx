                        ...
                        <div className={styles.contactInfo}>
                            ...
                            <div className={styles.trainingInfo}>
                                ...
                                <p className={styles.trainingDescription}>
                                    Мы проводим тренировки в любое время года! Зимой — лыжные гонки
                                    и ориентирование на лыжах, летом — классическое ориентирование
                                    бегом. Присоединяйтесь к нашему сообществу в ВКонтакте, чтобы
                                    быть в курсе всех тренировок и мероприятий.
                                </p>
                            </div>
                        </div>
                    </div>
